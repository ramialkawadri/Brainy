...
describe(parseGetFilesResponse, () => {
    it("Parse file list correctly", () => {
        ...
        const folder2: IFolder = {
            ...
            subFolders: [],
            files: [
                { id: 7, name: "file 1", /* repetitionCounts: {
                    new: 1, review: 1, learning: 1, relearning: 1,
                }*/},
                { id: 8, name: "file 2",/* repetitionCounts: {
        ...
        const folder1: IFolder = {
            ...
            files: [
                { id: 5, name: "file 1",/*repetitionCounts: {
                    new: 0, review: 0, learning: 1, relearning: 3,
                }*/},
                { id: 6, name: "file 2", /*repetitionCounts: {
        ...
        const folder3: IFolder = {
            ...
            files: [{ id: 9, name: "file 1", /*repetitionCounts: {
                new: 0, review: 0, learning: 0, relearning: 1,
            }*/}],
            subFolders: []
        };
        const expected: IFolder = {
            ...
            files: [{ id: 1, name: "file 1", /*repetitionCounts: {
